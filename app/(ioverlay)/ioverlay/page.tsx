...
export default function Page() {
    return (
        <div className="m-auto max-w-[1280px] py-16 text-[#484848]">
            ...
            <Image
                src="/ioverlay/ioverlay-dark.png"
                width={1280}
                height={700}
                alt="iOverlay identity on a dark background"
            />
            <Image
                src="/ioverlay/ioverlay-light.png"
                width={1280}
                height={700}
            ...
            <div className="grid grid-flow-row grid-cols-2 gap-[12px]">
                <Image src="/ioverlay/closeup.jpg" width={634} height={634} alt="" />
                <Image src="/ioverlay/portrait.jpg" width={634} height={634} alt="" />
                <Image className="col-span-2" src="/ioverlay/wordmark.jpg" width={1280} height={634} alt="" />
                <Image src="/ioverlay/clay001.jpg" width={634} height={634} alt="" />
                <Image src="/ioverlay/clay002.jpg" width={634} height={634} alt="" />
                <Image src="/ioverlay/isometric.jpg" width={634} height={634} alt="" />
                <Image src="/ioverlay/steps.jpg" width={634} height={634} alt="" />
            </div>

            <h2 className="mb-4 mt-8 text-center text-xl">Concept iteration, round 1</h2>
            <div className="m-auto max-w-[1050px]">
                <Image src="/ioverlay/round001.png" width={1050} height={524} alt="" />
            </div>

            <h2 className="mb-4 mt-8 text-center text-xl">Concept iteration, round 2</h2>
            <div className="m-auto max-w-[1050px]">
                <Image src="/ioverlay/round002.png" width={1050} height={1284} alt="" />
            </div>

            <h2 className="mb-4 mt-8 text-center text-xl">Concept iteration, round 3</h2>
            <div className="m-auto max-w-[1050px]">
                <Image src="/ioverlay/round003.png" width={1050} height={1020} alt="" />
            </div>

            <h2 className="mb-4 mt-8 text-center text-xl">Previous identity</h2>
            <div className="m-auto max-w-[1014px]">
                <Image src="/ioverlay/previous.png" width={1014} height={924} alt="" />
            </div>
        </div>
    );
}
