...
export function SeriesDetail({ series }: { series: OfficialSeries }) {
    ...
    return (
        <div className="font-semilight box-content flex w-full flex-col overflow-hidden md:flex-row md:border-[.5px] md:border-[rgba(90,90,90,0.15)] md:pt-0">
            ...
            <div className="shadow-pdfFrame relative mx-auto flex h-[426.66px] w-[320px] grow place-content-center overflow-hidden rounded-sm text-center md:mx-0 md:h-full md:w-full md:bg-white100 dark:md:bg-[#222222]">
