...
export function ThemeMoonGlyph({ className, title }: GlyphProps) {
    return (
        ...
        >
            ...
            <path fillRule="evenodd" clipRule="evenodd" d={THEME_MOON_PATH_D} fill="currentColor" />
        </svg>
    );
}

export function ThemeSunGlyph({ className, title }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 120 120"
            fill="none"
        ...
        >
            {title ? <title>{title}</title> : null}
            <path fillRule="evenodd" clipRule="evenodd" d={THEME_SUN_PATH_D} fill="currentColor" />
        </svg>
    );
}

/** Chunky sun/moon for the compact track toggle (120×120 originals wash out below ~24px). */
export function ThemeSunToggleIcon({ className, title }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        >
            {title ? <title>{title}</title> : null}
            <circle cx="12" cy="12" r="3.75" fill="currentColor" stroke="currentColor" strokeWidth="0.6" />
...
export function ThemeMoonToggleIcon({ className, title }: GlyphProps) {
    return (
        <svg
            viewBox="0 0 24 24"
            fill="none"
