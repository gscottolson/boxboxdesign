...
export default function ModeToggle({ darkMode, onToggle }: { darkMode: boolean; onToggle: () => void }) {
    ...
    return (
        <div
            onClick={handleClick}
            className="fixed top-[-72px] left-1/2 z-50 -ml-[60px] scale-75 cursor-pointer rounded-full shadow-md transition-[top,transform,box-shadow] duration-150 ease-in-out hover:top-[-64px] hover:scale-100 hover:shadow-lg max-[760px]:left-auto max-[760px]:right-6 max-[760px]:ml-0"
        >
            <svg
                width="120"
                height="120"
                ...
                className="text-[var(--fg-muted)] [transition:opacity_100ms_ease-out,transform_500ms_ease-in-out]"
                style={{
                    transform: `rotate(${rotation}deg)`,
                    opacity: rotation === DEFAULT_ROTATION ? 0 : 1,
                }}
            >
                <circle cx="60" cy="60" r="60" className="fill-[var(--bg)]" />
