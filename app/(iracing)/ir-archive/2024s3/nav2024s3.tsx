...
import { UpdatedDiscipline } from '@/app/(iracing)/iracing/types';
...
function Item({
    ...
    const itemURL = label === 'About the project' ? '/iracing/project' : url || getDisciplineURL(label, '2024s3'); // otherwise set it to the provided URL or the mapped discipline URL
    return (
        <li>
