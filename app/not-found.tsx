...
export default function NotFound() {
  return (
    <div className="bgWhite400 bg-white400 flex h-full w-full flex-col items-center justify-center gap-4 text-blue800">
      <Logo404 />
      <p className="mt-16 text-3xl font-light">
        The thing you were looking for isn’t here. Apologies.
      </p>
